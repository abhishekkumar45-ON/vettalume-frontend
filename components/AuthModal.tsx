...
export type AuthModalMode = "trial" | "signup" | "otp";
    ...
    <div className="authOverlay" role="dialog" aria-modal="true">
      ...
      {mode === "trial" ? (
        <section className="trialDialog" aria-labelledby="trial-title">
          ...
          <p>Get a taste of selected Blue Nelumbo sections with curated highlights from each.</p>
        ...
        <section className="authPanel" aria-labelledby={mode === "signup" ? "signup-title" : "otp-title"}>
          <Image className="authLogo" src="/Vettalume-LOGO.png" alt="" width={96} height={60} priority />

          {mode === "signup" ? (
            <>
              <h2 id="signup-title">Create your account</h2>
              <p>Sign up to start you prep journey</p>
              ...
              <form className="authForm">
                ...
                <label className="checkLine">
                  ...
                  />
                  I agree with Blue Nelumbo&apos;s Privacy Policy and Terms of Service.
                </label>
                <button className="button primary authSubmit" type="button" onClick={() => onModeChange("otp")}>
                  Get OTP
                </button>
              </form>
              <p className="authSwitch">Already have an account? <button type="button">Log In</button></p>
            </>
          ) : (
            <>
